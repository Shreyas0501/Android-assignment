...
class GridAdaptor(private val context: Activity, private val arrayList: ArrayList<Contact>) :
    ArrayAdapter<Contact>(context, R.layout.contact_grid_item, arrayList) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val fullNameString = arrayList[position].firstName + " " + arrayList[position].lastName
